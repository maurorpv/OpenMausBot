    ...
    <div>
      ...
      <div className="flex gap-2">
        <input
          ...
          placeholder={configured ? t("keys.replace") : t("transcription.placeholder")}
          aria-label={t("transcription.aria")}
          autoComplete="off"
          disabled={!bridge}
      ...
      >
        {t("transcription.dashboard")} <ExternalLink size={12} />
      </a>
      {!bridge && <div className="mt-1 text-[12px] text-warning">{t("transcription.desktopOnly")}</div>}
